...
{
    /// <summary>
    /// Sistema de partículas con física newtoniana propia:
    /// posición, velocidad, gravedad, fricción, vida.
    /// Sin librerías externas de física.
    /// </summary>
            ...
            float sizeMin = 2.5f, float sizeMax = 8f, float lifeMin = 0.7f, float lifeMax = 2.5f)
        {
            for (int i = 0; i < count; i++) {
                ...
                _particles.Add(new Particula {
                    ...
                    Life = lf, MaxLife = lf, Size = sz, Color = c });
            }
        }
