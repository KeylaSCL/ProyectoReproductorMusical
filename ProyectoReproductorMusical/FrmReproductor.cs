...
namespace ProyectoReproductorMusical
{
    public partial class FrmReproductor : Form
    {
        ...
        void InitUI()
        {
            ...
            // Construir los elementos sobre el contenedor ya agregado de forma segura
            BuildControlBar();
        ...
        void RepositionControls()
        {
            ...
            int totalBtns = _btnPrev.Width + _btnPlay.Width + _btnStop.Width + _btnNext.Width + 12 * 3;
            ...
            // CORRECCIÓN: Alineación responsiva adaptada al final de la lista
            if (_btnLoad != null)
                _btnLoad.Location = new Point(qEnd + 4, 70);
